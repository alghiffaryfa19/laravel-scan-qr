@extends('layouts.template')
  ...
  @section('page-title','Daftar Absen')
  @section('navbar')
  ...
  <div class="card">
    <div class="card-header">
        <a href="/invoice/print" class="btn btn-primary">Unduh Daftar Hadir</a>
    </div>
    <div class="card-body">
